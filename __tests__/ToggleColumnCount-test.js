...
import ToggleColumnCount from '../src/components/GalleryScreen/ToggleColumnCount';
import {fireEvent, render} from '@testing-library/react-native';
import GalleryStore from '../src/mobx/GalleryStore';
...
it('3. press the toggle', () => {
  ...
  const TestComponent = () => (
    <ToggleColumnCount
      toggleColumnCount={mockStore.toggleColumnCount.bind(mockStore)}
